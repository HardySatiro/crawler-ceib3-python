...
def delay_function(function):
    ...
    def wrapper(*args, **kwrds):
        delay_before = kwrds.pop("delay_before", os.environ.get("DELAY_BEFORE", 0.1))
        delay_after = kwrds.pop("delay_after", os.environ.get("DELAY_AFTER", 0.1))
        if delay_before:
